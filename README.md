...
Tính kế thừa (Inheritance): Lớp con có thể kế thừa các thuộc tính và phương thức của lớp cha, 
có thể chỉnh sửa và phát triển các thuộc tính và phương thức đó, sử dụng từ khoá <strong>extends</strong>.

Tính đa hình (Polymorphism): gồm 2 khái niệm ghi đè phương thức (overriding method) giúp lớp con có thể định nghĩa lại phương thức được kế thừa từ lớp cha, 
